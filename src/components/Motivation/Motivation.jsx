  ...
  return (
    <div className="container">
      <div className="section mot_section">
        ...
        <ul className="list">
          <li className="item">
            <img src={MotivationImg} alt="motivation" className="item_img" width='336' height='180'/>
          ...
          <li className="item">
            <img src={MotivationImg2} alt="mot_img2" className="item_img" width='336' height='180'/>
          ...
          <li className="item">
            <img src={MotivationImg3} alt="mot_img3" className="item_img" width='336' height='180'/>
